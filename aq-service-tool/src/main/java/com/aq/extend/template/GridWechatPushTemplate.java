...
/**
 * 
 * @ClassName: GridWechatPushTemplate
 * @Description: 网格工具模板
 * @author: lijie
 * @date: 2018年4月17日 上午10:43:52
 */
public class GridWechatPushTemplate extends WechatPushTemplateGenerate {
	...
	public WechatPushTemplateDTO createWechatPushTemplate(TemplateData data) {
		...
		dataMap.put("first", initData("欢迎使用" + ToolCategoryEnum.GRID.getDesc() + "实时推送服务，" + name));
