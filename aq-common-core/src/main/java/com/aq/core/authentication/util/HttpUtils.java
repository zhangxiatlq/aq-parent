package com.aq.core.authentication.util;
...
public class HttpUtils {
     ...
     * @throws Exception
     */
    public static HttpResult doGet(String host, String path, String method,
    ...
    private static CloseableHttpClient sslClient() {
        try {
            ...
            Registry<ConnectionSocketFactory> sfr = RegistryBuilder.<ConnectionSocketFactory>create().register
